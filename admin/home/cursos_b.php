...
<body>
  <div class="contenedor">
     ...
     <section>
        ...
        <h4>Ingresa la palabra clave <input id="myInput" type="text" placeholder="Search.."></h4>
            <?php  
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <a href="#" id="save" class="btn btn-primary pull-right"> Guardar </a>
                <a href="#" id="delete" class="btn btn-primary pull-right"> Eliminar </a>
